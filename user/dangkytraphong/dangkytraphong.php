                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mandatory">
                                                ...
                                                <input type="text" id="ma-sinh-vien" class="form-control" name="txtMaSV" value="<?php echo $maSV; ?>" disabled />
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="gioi-tinh" class="form-label">Giới tính</label>
                                                <input type="text" id="gioi-tinh" class="form-control" name="txtGioiTinh" value="<?php echo $gioiTinh; ?>" disabled />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
