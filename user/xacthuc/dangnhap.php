<?php
    ...
    // Thiết lập thời gian hết hạn phiên (30 phút)
    ...
    $_SESSION['LAST_ACTIVITY'] = time(); // Cập nhật thời gian hoạt động cuối
    ...
    if (isset($_POST['login'])) {
        ...
        $sql_dangnhap = "SELECT * FROM taikhoan WHERE TenDangNhap = '" . $ma . "' AND MatKhau = '" . $mk . "' AND TenLTK = 'sv'";
        ...
        if ($count_dangnhap == 0) {
            ...
            $sql_sinhvien = "SELECT * FROM sinhvien WHERE MaSV = '" . $ma . "'";
            $run_sinhvien = mysqli_query($conn, $sql_sinhvien);
            $sinhvien = mysqli_fetch_array($run_sinhvien);
            $_SESSION['sv'] = $sinhvien;

            // Lưu cookie nếu checkbox "Lưu mật khẩu" được chọn
            if (isset($_POST['remember'])) {
                setcookie('masv', $ma, time() + (86400 * 30), "/"); // Lưu trong 30 ngày
                ...
                <div id="auth-left">
                    ...
                    <form action="dangnhap.php" method="POST">
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" id="inputEmail" name="masv" class="form-control form-control-xl" placeholder="Mã sinh viên" 
                                value="<?php if(isset($_COOKIE['masv'])) { echo $_COOKIE['masv']; } ?>" required autofocus>
                        ...
                        <div class="form-check form-check-lg d-flex align-items-end">
                            <input class="form-check-input me-2" type="checkbox" name="remember" id="flexCheckDefault" 
                                <?php if(isset($_COOKIE['masv'])) { echo 'checked'; } ?>>
